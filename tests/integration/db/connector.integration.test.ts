...
describe('QueryExecutor Integration', () => {
  ...
  it('should execute a Cypher query', async () => {
    try {
      ...
      // Skip this test if AGE is not available or we don't have permissions
      console.warn('Skipping Cypher test: Apache AGE extension not available or permission denied');
