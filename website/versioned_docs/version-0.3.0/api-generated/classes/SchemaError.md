...
[age-schema-client](/ageSchemaClient/api-generated/index.md) / SchemaError

# Class: SchemaError

Defined in: [src/schema/errors.ts:10](https://github.com/standardbeagle/ageSchemaClient/blob/main/src/schema/errors.ts#L10)
...
```ts
new SchemaError(message, cause?): SchemaError;
```

Defined in: [src/schema/errors.ts:17](https://github.com/standardbeagle/ageSchemaClient/blob/main/src/schema/errors.ts#L17)
...
| <a id="cause"></a> `cause?` | `readonly` | `unknown` | Error cause | - | [src/schema/errors.ts:17](https://github.com/standardbeagle/ageSchemaClient/blob/main/src/schema/errors.ts#L17) |
